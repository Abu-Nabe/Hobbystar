...
public class VidClick extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VidsRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot datasnapshot)
            {
                for(DataSnapshot snapshot:datasnapshot.getChildren())
                {
                    ...
                    if(model.getTimestring().equals(click1)) {
                        videoList.add(model);
                    }
                }
            }
        ...
        zingingVideoAdapter = new ZingingVideoAdapter(VidClick.this, videoList);
        clickrecyclerview.setAdapter(zingingVideoAdapter);
