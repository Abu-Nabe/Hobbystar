...
public class ZingingPicture extends RecyclerView.Adapter<ZingingPicture.ViewHolder>
{
    private Context mContext;
    private ArrayList<ZingingPics> ProfileZinging;

    public ZingingPicture(Context mContext, ArrayList<ZingingPics> profileZinging) {
    ...
    {
        View view = LayoutInflater.from(mContext).inflate(R.layout.zingingpicture, viewGroup, false);

        return new ZingingPicture.ViewHolder(view);
    }
