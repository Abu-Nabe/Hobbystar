...
public class CategorySpinner1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(CategorySpinner1.this, "Select A Hobby", Toast.LENGTH_SHORT).show();
                }else{
                    Intent intent = new Intent(CategorySpinner1.this, CategoryVid.class);
