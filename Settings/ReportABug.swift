...
class ReportABug: UIViewController
{
    ...
    private let label: UILabel = {
        ...
        label.text = "Tell us about the bug you've spotted!"
    ...
    private let SuggestionField: UITextField = {
        ...
        EmailField.placeholder = "Tell us about the bug"
    ...
    @objc func SaveSuggestion()
    {
        ...
        if text == ""
        {
            ...
            ref.child("bugs").child(Auth!).setValue(data)
